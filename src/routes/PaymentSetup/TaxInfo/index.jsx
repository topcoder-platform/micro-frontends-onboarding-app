...
import { BUTTON_TYPE, PAYMENT_STEPS, TAX_INFO_CONTENT, IRS_W8_BEN_URL } from "constants";
    ...
    <Page title="Payment Setup" styleName="page-wrapper">
      ...
      <div styleName="tax-info">
        <PageContent styleName="page-content">
          ...
          <PageH1 styleName="tax-info-title">Topcoder Tax Information for Form W-8BEN</PageH1>
          <PageDivider styleName={cn("page-divider", "title-divider")} />

          <div styleName="static-content" dangerouslySetInnerHTML={{__html: TAX_INFO_CONTENT}}></div>
          ...
          <PageFoot styleName="footer">
            ...
            <div>
              <Button onClick={onSeeInstructions} styleName="see-instructions-desktop" type={BUTTON_TYPE.SECONDARY}>
                see instructions for form w-8BEN
              </Button>
              <Button onClick={onSeeInstructions} styleName="see-instructions-mobile" type={BUTTON_TYPE.SECONDARY}>
                see instructions
              </Button>
            </div>
          </PageFoot>
