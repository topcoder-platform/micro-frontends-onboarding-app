...
const PageListInput = ({ items, name, title, heading, desc, addListInputItem, styleName, children }) => {
  return (
    <div styleName={cn("page-list-input", styleName || "" )}>
      ...
      <PageRow half={true} styleName="form-row">
        ...
        <div>
          <div styleName="listinput-itemslist">
            {children}
          </div>
          <div styleName="add-listinput-item-button" onClick={e => addListInputItem(name)}>
            <IconPlus styleName="icon-add"/> Add Another {title}
          </div>
        </div>
      </PageRow>
    </div>
