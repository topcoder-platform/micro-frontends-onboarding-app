...
const EmailDetails = ({paymentMethod}) => {
  ...
  return (
    <div styleName="email-details">
      <PageH3 styleName="title">Do you have your {PAYMENT_METHOD_MAP[paymentMethod]} account details? Great!</PageH3>
      <ul styleName="instructions">
        {
          instructions.map((instruction) => (
            <li>
              ...
              <ul styleName="instructions">
                {
                  instruction.children && instruction.children.map((child) => <li dangerouslySetInnerHTML={{__html: child}} />)
                }
              </ul>
            </li>
          ))
