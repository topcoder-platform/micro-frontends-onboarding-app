...
# Topcoder onboarding App

This is the Topcoder Onboarding micro application. This is to be loaded in Topcoder micro-frontends-frame [single-spa](https://single-spa.js.org/) application.
...
- As this app can be loaded only inside a frame single-spa, you have to run a `micro-frontends-frame` frame app and configure it to use the URL `http://localhost:8010/onboarding-app/topcoder-micro-frontends-onboarding-app.js`.
